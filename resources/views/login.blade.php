                    ...
                    <div class="row d-flex py-5 justify-content-center align-items-center h-100">
                        <div class="col col-xl-10">
                            <div class="card" style="border-radius: 1rem;">
                                <div class="row g-0">
                                    <div
                                        class="col-md-6 col-lg-5 d-none d-md-flex justify-content-center align-items-center">
                                        <img src="img/login.png" alt="Login Image" class="img-fluid"
                                    ...
                                    <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                        <div class="card-body p-4 p-lg-5 text-black">
                                            ...
                                            <form method="POST" action="{{ route('login') }}">
                                                ...
                                                @endif
                                                <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Log in into
                                                    your account</h5>
                                                ...
                                                <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a
                                                        href="{{ url('/register') }}" class="btn-link">Register here</a>
                                                </p>
