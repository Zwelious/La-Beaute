                        ...
                        @foreach ($dataProducts as $product)
                            <div class="col-md-6 col-lg-6 col-xl-4">
                                <a href="{{ route('shop-details', ['id_prod' => $product->ID_PROD]) }}"
                                    class="text-decoration-none text-dark"> <!-- Anchor tag starts here -->
                                    <div class="rounded position-relative fruite-item">
                                        ...
                                        <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                            style="top: 10px; left: 10px;">{{ $product->KATEGORI }}</div>
            ...
            <div class="owl-carousel vegetable-carousel justify-content-center">
                <div class="border border-primary rounded position-relative vesitable-item">
                    ...
                    <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                        style="top: 10px; right: 10px;">Lips</div>
                    <div class="p-4 rounded-bottom">
                        <h4 class="product-title">
                            ROMAND Dewyful Water Tint</h4>
                        <p class="product-description">
                            Boost the color with a glossy glow! A dewy-ful & long-lasting lip tint that forms like a welcome
                            rain on my lips
                ...
                <div class="border border-primary rounded position-relative vesitable-item">
                    ...
                    <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                        style="top: 10px; right: 10px;">Face</div>
                    <div class="p-4 rounded-bottom">
                        <h4 class="product-title">
                            PINKFLASH Oil Controller Loose Powder
                        </h4>
                        <p class="product-description">
                            Matte and natural flawless makeup effect. 💫Oil Controller - It can control oil in 1 second and
                            not feel oily all day, creating an extreme matte makeup.
                            <span class="more-text d-none"></span>
                        </p>
                        <div class="d-flex flex-column">
                            <div class="price-wrap mb-2">
                ...
                <div class="border border-primary rounded position-relative vesitable-item">
                    ...
                    <div class="p-4 rounded-bottom">
                        ...
                        <p class="product-description">
                            Brand new dual-ended design, more shades and more texture, satisfied with your variety of makeup
                            finish. 💕TIPS: before applying lipstick, use PINKFLASH lip oil to moisturize the lips.
                            <span class="more-text d-none"></span>
                        </p>
                        <div class="d-flex flex-column">
                            <div class="price-wrap mb-2">
                ...
                <div class="border border-primary rounded position-relative vesitable-item">
                    ...
                    <div class="p-4 rounded-bottom">
                        ...
                        <p class="product-description">
                            The 1st Dior lip balm formulated with 97% natural-origin ingredients that subtly revives the
                            natural color of lips with a custom glow and hydrates lips for 24h.
                            <span class="more-text d-none"></span>
                        </p>
                        <div class="d-flex flex-column">
                            <div class="price-wrap mb-2">
                ...
                <div class="border border-primary rounded position-relative vesitable-item">
                    ...
                    <div class="p-4 rounded-bottom">
                        ...
                        <p class="product-description">
                            Dior Addict Lip Tint is the first no-transfer Dior lip tint with 12h wear,that highlights the
                            lips with a bold color in a semi-matte finish and fuses with the skin for a bare-lip sensation.
                            <span class="more-text d-none"></span>
                ...
                <div class="border border-primary rounded position-relative vesitable-item">
                    ...
                    <div class="p-4 rounded-bottom">
                        ...
                        <p class="product-description">
                            A new powder highlighter to brighten, draw attention, and stun. This Veilighter contours and
                            reflects light beautifully for a goddess-like glow.
                            <span class="more-text d-none"></span>
                        </p>
                        <div class="d-flex flex-column">
                            <div class="price-wrap mb-2">
                ...
                <div class="border border-primary rounded position-relative vesitable-item">
                    ...
                    <div class="p-4 rounded-bottom">
                        ...
                        <p class="product-description">
                            Dior Forever Natural Velvet is the 1st no-transfer Dior compact foundationwith 24h wear,composed
                            with 90% natural-origin ingredients. Ultra-soft and light, it brings a naturally matte
                            perfection to the complexion, with a fine and creamy texture that lets the skin breathe while
                            offering a sensation of comfort that lasts all day. Its high coverage corrects blemishes,
            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-6">
                    <div class="py-4">
                        ...
                        <p class="mb-4 text-white">Start your beauty goals with us, right here right now. Get in touch with
                            us!</p>
                        <a href="{{ url('/shop') }}"
