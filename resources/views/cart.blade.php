                            ...
                            <div class="card border shadow-0">
                                <div class="m-4">
                                    ...
                                    @if ($cartProducts->isEmpty())
                                        <p>Your wishlist is empty. To add products to your wishlist, click on the heart icon
                                            on a product!</p>
                                    @else
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <button class="btn btn-light border"
                                                                        onclick="changeQuantity('{{ $cart->ID_PROD }}', '{{ $cart->QTY }}', -1)">-</button>
                                                                    <input type="text"
                                                                        id="quantity-{{ $cart->ID_PROD }}"
                                                                        value="{{ $cart->QTY }}"
                                        ...
                                        <div class="border-top pt-4 mx-4 mb-4">
                                            ...
                                            <p class="text-muted">
                                                Enjoy complimentary shipping on all orders with no minimum purchase
                                                required. Expedited shipping options are available at an additional cost.
                        ...
                        <div class="col-lg-3">
                            <div class="card mb-3 border shadow-0">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        <a href="{{ route('checkout') }}" class="btn btn-success w-100 shadow-0 mb-2"> Make
                                            Purchase </a>
