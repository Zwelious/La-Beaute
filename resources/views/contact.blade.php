                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-12">
                        <div class="h-100 rounded">
                            ...
                            style="height: 400px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d16249089.789830966!2d96.80776125965247!3d-6.122231904847554!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7fde455555555%3A0xd7e2611ae591f046!2sUniversitas%20Ciputra%20Surabaya!5e0!3m2!1sen!2sid!4v1717921211569!5m2!1sen!2sid"
                    ...
                    <div class="col-lg-7">
                        <form method="POST" action="{{ route('contact.store') }}" class="">
                            @csrf
                            <input type="text" name="name" class="w-100 form-control border-0 py-3 mb-4" placeholder="Enter Your Name" required>
                            <input type="email" name="email" class="w-100 form-control border-0 py-3 mb-4" placeholder="Enter Your Email" required>
                            <textarea name="message" class="w-100 form-control border-0 mb-4" rows="5" cols="10" placeholder="Enter Your Message" required></textarea>
