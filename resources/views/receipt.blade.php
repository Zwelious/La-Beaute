            ...
            <div class="card-body mt-5">
                <div class="container mb-5 mt-5">
                    <div class="row d-flex align-items-baseline justify-content-cente">
                        <div class="col-xl-9">
                            <p style="color: #7e8d9f;font-size: 20px;">Invoice >> <strong><b>ID:
                                        #{{ $transaction->ID_TRANS }}<b></strong></p>
                        </div>
                        <hr>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <ul class="list-unstyled">
                                <li class="text-primary"><i class="fas fa-circle"></i> <span class="fw-bold">ID: </span>
                                    #{{ $transaction->ID_TRANS }}</li>
                                <li class="text-primary"><i class="fas fa-circle"></i> <span class="fw-bold">Creation Date:
                                    </span>{{ $transaction->TANGGAL }}</li>
                            ...
                            <tbody>
                                ...
                                @foreach ($cartProducts as $key => $product)
                                    <tr>
                                        ...
                                        <td>{{ $product->QTY }}</td>
                                        <td>{{ $product->HARGA }}</td>
                                        <!-- Calculate and display the total price per item after discount -->
                                        @php
                                            $discountedPrice =
                                                $product->DISKON > 0
                                                    ? $product->HARGA * (1 - $product->DISKON / 100)
                                                    : $product->HARGA;
                                            $totalItemPrice = $discountedPrice * $product->QTY;
                                        @endphp
